...
const server: Record<string, string> = {
  ...
  "server:A brief is at most 8000 characters.":
    "Een briefing is maximaal 8000 tekens.",
  "server:A campaign name is between 2 and 80 characters.":
    "Een campagnenaam is tussen de 2 en 80 tekens.",
  ...
  "server:A keyword is at least two characters.":
    "Een trefwoord is minstens twee tekens.",
  ...
  "server:A name is lower-case letters, numbers and underscores.":
    "Een naam bestaat uit kleine letters, cijfers en liggende streepjes.",
  ...
  "server:A routine starts on schedule, on mention or on keyword.":
    "Een routine start op de klok, bij een vermelding of bij een trefwoord.",
  "server:A routineRunId is required.": "Een routineRunId is verplicht.",
  "server:A server name is lower-case letters, numbers and hyphens.":
    "Een servernaam bestaat uit kleine letters, cijfers en streepjes.",
  ...
  "server:That address redirected to another host, and this deployment will not forward the run to it.":
    "Dat adres verwees door naar een andere host, en deze omgeving stuurt de run daar niet heen.",
  ...
  "server:That does not look like an API key: too short, or it has spaces in it.":
    "Dat lijkt geen API-sleutel: te kort, of er zitten spaties in.",
  "server:That is not a credential this server can use. Add the server's own token instead.":
    "Dat is geen toegangsgegeven dat deze server kan gebruiken. Voeg het eigen token van de server toe.",
